...
public class MessageCracker {
	...
	/**
	 * Callback for FIXTradeBust message.
	 *
	 * @param message
	 * @param sessionID
	 * @throws FieldNotFound
	 ...
	 * @throws IncorrectTagValue
	 */
	public void onMessage(TradeBust message, SessionID sessionID) throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
		throw new UnsupportedMessageType();
	}
	...
	public void crack42(Message message, SessionID sessionID)
		...
		else if (type.equals(TradeBust.MSGTYPE))
			onMessage((TradeBust)message, sessionID);
		else
